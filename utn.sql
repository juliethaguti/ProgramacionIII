...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-10-2019 a las 03:02:11
...
--
ALTER TABLE `productos`
  MODIFY `pNumero` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `proveedores`
--
ALTER TABLE `proveedores`
  MODIFY `Numero` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
COMMIT;
